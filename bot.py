...
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY", "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")
...
# ---------------------------
@bot.message_handler(func=lambda m: m.reply_to_message and isinstance(m.reply_to_message.text, str) and "Type the word you found" in m.reply_to_message.text and m.text and not m.text.startswith('/'), content_types=['text'])
